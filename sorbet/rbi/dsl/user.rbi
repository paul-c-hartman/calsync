...
class User
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `User` class because it declared `has_many :calendars, through: :user_accounts`.
    ...
    # This method is created by ActiveRecord on the `User` class because it declared `has_many :user_accounts`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::UserAccount::PrivateCollectionProxy) }
    def user_accounts; end

    sig { params(value: T::Enumerable[::UserAccount]).void }
