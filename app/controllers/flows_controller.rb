...
class FlowsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @flow.update(flow_params)
        format.html { redirect_to @flow, notice: "Flow was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to flows_path, notice: "Flow was successfully destroyed.", status: :see_other }
